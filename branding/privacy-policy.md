...
- your achievement data for supported games
...
STEAMER uses a Cloudflare Worker as a lightweight backend proxy for Steam Web API requests that require a server-side API key.
...
You can remove locally cached data by signing out of the app.

## Children

STEAMER is not directed to children under 13.

## Changes

This privacy policy may be updated from time to time. Any updates should be published at the same public URL used in your Play Store listing.
