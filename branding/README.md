...
- `app-icon-1024.png`: high-resolution master icon
- `play-store-icon-512.png`: Play Store sized listing icon
- `feature-graphic.png`: Play Store feature graphic
- `feature-copy.txt`: short marketing copy for store/listing reuse
- `play-store-listing.md`: drafted listing copy
- `privacy-policy.md`: privacy policy draft
- `release-prep.md`: release readiness notes
